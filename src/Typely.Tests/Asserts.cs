...
internal static class Asserts
{
    ...
    public static void ValidationMatchPredicate<TTypelyValue, TUnderlyingValue>(Gen<TUnderlyingValue> gen,
        Func<TUnderlyingValue, bool> predicate, TUnderlyingValue valueThatReturnError)
