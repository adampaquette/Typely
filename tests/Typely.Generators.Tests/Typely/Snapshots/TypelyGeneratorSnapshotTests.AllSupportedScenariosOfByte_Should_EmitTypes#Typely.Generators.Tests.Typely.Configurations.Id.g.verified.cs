...
{
    [TypeConverter(typeof(TypelyTypeConverter<byte, Id>))]
    [JsonConverter(typeof(TypelyJsonConverter<byte, Id>))]
    public partial class Id : ITypelyValue<byte, Id>, IEquatable<Id>, IComparable<Id>, IComparable
    {
        ...
        {
            TypelyValue.ValidateAndThrow<byte, Id>(value);
            Value = value;
        }

        public static ValidationError? Validate(byte value) => null;

        public static Id From(byte value) => new(value);

        public static bool TryFrom(byte value, [MaybeNullWhen(false)] out Id typelyType, out ValidationError? validationError)
        {
        ...
        public static explicit operator byte(Id value) => value.Value;
    }
}