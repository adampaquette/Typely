...
{
    [TypeConverter(typeof(TypelyTypeConverter<float, Id>))]
    [JsonConverter(typeof(TypelyJsonConverter<float, Id>))]
    public partial class Id : ITypelyValue<float, Id>, IEquatable<Id>, IComparable<Id>, IComparable
    {
        ...
        {
            TypelyValue.ValidateAndThrow<float, Id>(value);
            Value = value;
        }

        public static ValidationError? Validate(float value) => null;

        public static Id From(float value) => new(value);

        public static bool TryFrom(float value, [MaybeNullWhen(false)] out Id typelyType, out ValidationError? validationError)
        {
        ...
        public static explicit operator float(Id value) => value.Value;
    }
}