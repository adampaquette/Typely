...
{
    [TypeConverter(typeof(TypelyTypeConverter<sbyte, Id>))]
    [JsonConverter(typeof(TypelyJsonConverter<sbyte, Id>))]
    public partial class Id : ITypelyValue<sbyte, Id>, IEquatable<Id>, IComparable<Id>, IComparable
    {
        public sbyte Value { get; private set; }

        public Id() => throw new Exception("Parameterless constructor is not allowed.");

        public Id(sbyte value)
        {
            TypelyValue.ValidateAndThrow<sbyte, Id>(value);
            Value = value;
        }

        public static ValidationError? Validate(sbyte value) => null;

        public static Id From(sbyte value) => new(value);

        public static bool TryFrom(sbyte value, [MaybeNullWhen(false)] out Id typelyType, out ValidationError? validationError)
        {
        ...
        public static explicit operator sbyte(Id value) => value.Value;
    }
}