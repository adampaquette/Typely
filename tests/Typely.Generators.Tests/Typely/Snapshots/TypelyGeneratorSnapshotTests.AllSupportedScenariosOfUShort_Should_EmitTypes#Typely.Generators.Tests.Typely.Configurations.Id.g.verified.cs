...
{
    [TypeConverter(typeof(TypelyTypeConverter<ushort, Id>))]
    [JsonConverter(typeof(TypelyJsonConverter<ushort, Id>))]
    public partial class Id : ITypelyValue<ushort, Id>, IEquatable<Id>, IComparable<Id>, IComparable
    {
        ...
        {
            TypelyValue.ValidateAndThrow<ushort, Id>(value);
            Value = value;
        }

        public static ValidationError? Validate(ushort value) => null;

        public static Id From(ushort value) => new(value);

        public static bool TryFrom(ushort value, [MaybeNullWhen(false)] out Id typelyType, out ValidationError? validationError)
        {
        ...
        public static explicit operator ushort(Id value) => value.Value;
    }
}