...
{
    [TypeConverter(typeof(TypelyTypeConverter<decimal, Id>))]
    [JsonConverter(typeof(TypelyJsonConverter<decimal, Id>))]
    public partial class Id : ITypelyValue<decimal, Id>, IEquatable<Id>, IComparable<Id>, IComparable
    {
        ...
        {
            TypelyValue.ValidateAndThrow<decimal, Id>(value);
            Value = value;
        }

        public static ValidationError? Validate(decimal value) => null;

        public static Id From(decimal value) => new(value);

        public static bool TryFrom(decimal value, [MaybeNullWhen(false)] out Id typelyType, out ValidationError? validationError)
        {
        ...
        public static explicit operator decimal(Id value) => value.Value;
    }
}