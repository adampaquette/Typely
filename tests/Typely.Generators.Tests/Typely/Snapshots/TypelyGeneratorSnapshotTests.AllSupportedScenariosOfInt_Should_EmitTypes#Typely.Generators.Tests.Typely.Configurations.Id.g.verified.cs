...
{
    [TypeConverter(typeof(TypelyTypeConverter<int, Id>))]
    ...
    public partial class Id : ITypelyValue<int, Id>, IEquatable<Id>, IComparable<Id>, IComparable
    {
        ...
        public Id(int value)
        {
            TypelyValue.ValidateAndThrow<int, Id>(value);
            Value = value;
        }

        public static ValidationError? Validate(int value) => null;

        public static Id From(int value) => new(value);

        public static bool TryFrom(int value, [MaybeNullWhen(false)] out Id typelyType, out ValidationError? validationError)
        {
        ...
        public static explicit operator int(Id value) => value.Value;
    }
}