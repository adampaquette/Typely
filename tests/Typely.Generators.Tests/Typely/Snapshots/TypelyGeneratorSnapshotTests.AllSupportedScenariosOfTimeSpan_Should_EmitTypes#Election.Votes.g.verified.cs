...
namespace Election
{
    ...
    public partial struct Votes : ITypelyValue<TimeSpan, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        ...
        public static bool TryFrom(TimeSpan value, [MaybeNullWhen(false)] out Votes typelyType, out ValidationError? validationError)
        {
