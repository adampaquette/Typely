...
namespace Election
{
    [TypeConverter(typeof(TypelyTypeConverter<TimeSpan, Votes>))]
    [JsonConverter(typeof(TypelyJsonConverter<TimeSpan, Votes>))]
    public readonly partial struct Votes : ITypelyValue<TimeSpan, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        public TimeSpan Value { get; }

        private Votes(TimeSpan value, bool byPassValidation)
        {
            Value = value;
        }

        public Votes(TimeSpan value)
        {
            TypelyValue.ValidateAndThrow<TimeSpan, Votes>(value);
            Value = value;
        }

        public static ValidationError? Validate(TimeSpan value)
        {
            if (value == default)
            {
        ...
        public static Votes From(TimeSpan value) => new(value);

        public static bool TryFrom(TimeSpan value, out Votes typelyType, out ValidationError? validationError)
        {
        ...
        {
            if(TimeSpan.TryParse(value, out var underlyingValue))
            {
        ...
        public static explicit operator TimeSpan(Votes value) => value.Value;
    }
}