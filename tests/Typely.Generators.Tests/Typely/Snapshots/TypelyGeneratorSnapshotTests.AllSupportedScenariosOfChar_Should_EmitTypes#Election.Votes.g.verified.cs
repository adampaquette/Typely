...
namespace Election
{
    ...
    public readonly partial struct Votes : ITypelyValue<char, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        public char Value { get; }

        private Votes(char value, bool byPassValidation)
        {
            Value = value;
        }
