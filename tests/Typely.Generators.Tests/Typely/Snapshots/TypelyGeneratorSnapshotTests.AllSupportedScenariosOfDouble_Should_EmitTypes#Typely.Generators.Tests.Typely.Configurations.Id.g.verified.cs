...
{
    [TypeConverter(typeof(TypelyTypeConverter<double, Id>))]
    [JsonConverter(typeof(TypelyJsonConverter<double, Id>))]
    public partial class Id : ITypelyValue<double, Id>, IEquatable<Id>, IComparable<Id>, IComparable
    {
        ...
        {
            TypelyValue.ValidateAndThrow<double, Id>(value);
            Value = value;
        }

        public static ValidationError? Validate(double value) => null;

        public static Id From(double value) => new(value);

        public static bool TryFrom(double value, [MaybeNullWhen(false)] out Id typelyType, out ValidationError? validationError)
        {
        ...
        public static explicit operator double(Id value) => value.Value;
    }
}