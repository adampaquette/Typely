...
{
    [TypeConverter(typeof(TypelyTypeConverter<uint, Id>))]
    [JsonConverter(typeof(TypelyJsonConverter<uint, Id>))]
    public partial class Id : ITypelyValue<uint, Id>, IEquatable<Id>, IComparable<Id>, IComparable
    {
        ...
        {
            TypelyValue.ValidateAndThrow<uint, Id>(value);
            Value = value;
        }

        public static ValidationError? Validate(uint value) => null;

        public static Id From(uint value) => new(value);

        public static bool TryFrom(uint value, [MaybeNullWhen(false)] out Id typelyType, out ValidationError? validationError)
        {
        ...
        public static explicit operator uint(Id value) => value.Value;
    }
}