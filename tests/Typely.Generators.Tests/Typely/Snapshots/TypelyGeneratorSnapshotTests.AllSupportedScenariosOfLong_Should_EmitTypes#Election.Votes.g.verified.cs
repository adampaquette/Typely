...
namespace Election
{
    [TypeConverter(typeof(TypelyTypeConverter<long, Votes>))]
    [JsonConverter(typeof(TypelyJsonConverter<long, Votes>))]
    public readonly partial struct Votes : ITypelyValue<long, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        public long Value { get; }

        private Votes(long value, bool byPassValidation)
        {
            Value = value;
        }

        public Votes(long value)
        {
            TypelyValue.ValidateAndThrow<long, Votes>(value);
            Value = value;
        }

        public static ValidationError? Validate(long value)
        {
            if (value == default)
            {
        ...
        public static Votes From(long value) => new(value);

        public static bool TryFrom(long value, out Votes typelyType, out ValidationError? validationError)
        {
        ...
        {
            if(long.TryParse(value, out var underlyingValue))
            {
        ...
        public static explicit operator long(Votes value) => value.Value;
    }
}