...
namespace Election
{
    ...
    public partial struct Votes : ITypelyValue<long, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        ...
        public static bool TryFrom(long value, [MaybeNullWhen(false)] out Votes typelyType, out ValidationError? validationError)
        {
