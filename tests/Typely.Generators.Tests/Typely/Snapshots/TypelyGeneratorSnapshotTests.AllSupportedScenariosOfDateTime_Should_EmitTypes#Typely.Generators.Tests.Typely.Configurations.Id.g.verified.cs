...
{
    [TypeConverter(typeof(TypelyTypeConverter<DateTime, Id>))]
    [JsonConverter(typeof(TypelyJsonConverter<DateTime, Id>))]
    public partial class Id : ITypelyValue<DateTime, Id>, IEquatable<Id>, IComparable<Id>, IComparable
    {
        public DateTime Value { get; private set; }

        public Id() => throw new Exception("Parameterless constructor is not allowed.");

        public Id(DateTime value)
        {
            TypelyValue.ValidateAndThrow<DateTime, Id>(value);
            Value = value;
        }

        public static ValidationError? Validate(DateTime value) => null;

        public static Id From(DateTime value) => new(value);

        public static bool TryFrom(DateTime value, [MaybeNullWhen(false)] out Id typelyType, out ValidationError? validationError)
        {
        ...
        public static explicit operator DateTime(Id value) => value.Value;
    }
}