...
{
    [TypeConverter(typeof(TypelyTypeConverter<Guid, Id>))]
    [JsonConverter(typeof(TypelyJsonConverter<Guid, Id>))]
    public partial class Id : ITypelyValue<Guid, Id>, IEquatable<Id>, IComparable<Id>, IComparable
    {
        ...
        {
            TypelyValue.ValidateAndThrow<Guid, Id>(value);
            Value = value;
        }

        public static ValidationError? Validate(Guid value) => null;

        public static Id From(Guid value) => new(value);

        public static bool TryFrom(Guid value, [MaybeNullWhen(false)] out Id typelyType, out ValidationError? validationError)
        {
        ...
        public static explicit operator Guid(Id value) => value.Value;
    }
}