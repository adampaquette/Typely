...
namespace Election
{
    ...
    public partial struct Votes : ITypelyValue<decimal, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        ...
        public static bool TryFrom(decimal value, [MaybeNullWhen(false)] out Votes typelyType, out ValidationError? validationError)
        {
