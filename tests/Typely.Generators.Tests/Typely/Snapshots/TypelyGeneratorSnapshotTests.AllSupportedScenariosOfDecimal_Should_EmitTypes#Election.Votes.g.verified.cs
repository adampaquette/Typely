...
namespace Election
{
    [TypeConverter(typeof(TypelyTypeConverter<decimal, Votes>))]
    [JsonConverter(typeof(TypelyJsonConverter<decimal, Votes>))]
    public readonly partial struct Votes : ITypelyValue<decimal, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        public decimal Value { get; }

        private Votes(decimal value, bool byPassValidation)
        {
            Value = value;
        }

        public Votes(decimal value)
        {
            TypelyValue.ValidateAndThrow<decimal, Votes>(value);
            Value = value;
        }

        public static ValidationError? Validate(decimal value)
        {
            if (value == default)
            {
        ...
        public static Votes From(decimal value) => new(value);

        public static bool TryFrom(decimal value, out Votes typelyType, out ValidationError? validationError)
        {
        ...
        {
            if(decimal.TryParse(value, out var underlyingValue))
            {
        ...
        public static explicit operator decimal(Votes value) => value.Value;
    }
}