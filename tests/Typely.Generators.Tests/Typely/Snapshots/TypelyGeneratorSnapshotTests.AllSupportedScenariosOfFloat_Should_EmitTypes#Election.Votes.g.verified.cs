...
namespace Election
{
    ...
    public readonly partial struct Votes : ITypelyValue<float, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        public float Value { get; }

        private Votes(float value, bool byPassValidation)
        {
            Value = value;
        }
