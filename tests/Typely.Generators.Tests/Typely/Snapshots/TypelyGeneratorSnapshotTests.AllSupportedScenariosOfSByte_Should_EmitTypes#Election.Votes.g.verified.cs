...
namespace Election
{
    ...
    public readonly partial struct Votes : ITypelyValue<sbyte, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        public sbyte Value { get; }

        private Votes(sbyte value, bool byPassValidation)
        {
            Value = value;
        }
