...
namespace Election
{
    [TypeConverter(typeof(TypelyTypeConverter<ulong, Votes>))]
    [JsonConverter(typeof(TypelyJsonConverter<ulong, Votes>))]
    public readonly partial struct Votes : ITypelyValue<ulong, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        public ulong Value { get; }

        private Votes(ulong value, bool byPassValidation)
        {
            Value = value;
        }

        public Votes(ulong value)
        {
            TypelyValue.ValidateAndThrow<ulong, Votes>(value);
            Value = value;
        }

        public static ValidationError? Validate(ulong value)
        {
            if (value == default)
            {
        ...
        public static Votes From(ulong value) => new(value);

        public static bool TryFrom(ulong value, out Votes typelyType, out ValidationError? validationError)
        {
        ...
        public static explicit operator ulong(Votes value) => value.Value;
    }
}