...
namespace Election
{
    ...
    public readonly partial struct Votes : ITypelyValue<short, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        public short Value { get; }

        private Votes(short value, bool byPassValidation)
        {
            Value = value;
        }
