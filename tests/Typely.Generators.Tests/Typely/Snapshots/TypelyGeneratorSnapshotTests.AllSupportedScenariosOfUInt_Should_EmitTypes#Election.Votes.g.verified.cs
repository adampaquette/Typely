...
namespace Election
{
    ...
    public partial struct Votes : ITypelyValue<uint, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        ...
        public static bool TryFrom(uint value, [MaybeNullWhen(false)] out Votes typelyType, out ValidationError? validationError)
        {
