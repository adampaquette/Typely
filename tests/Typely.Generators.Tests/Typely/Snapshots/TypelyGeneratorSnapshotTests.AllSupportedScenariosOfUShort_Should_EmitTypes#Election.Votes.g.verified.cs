...
namespace Election
{
    ...
    public partial struct Votes : ITypelyValue<ushort, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        ...
        public static bool TryFrom(ushort value, [MaybeNullWhen(false)] out Votes typelyType, out ValidationError? validationError)
        {
