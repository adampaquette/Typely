...
namespace Election
{
    [TypeConverter(typeof(TypelyTypeConverter<ushort, Votes>))]
    [JsonConverter(typeof(TypelyJsonConverter<ushort, Votes>))]
    public readonly partial struct Votes : ITypelyValue<ushort, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        public ushort Value { get; }

        private Votes(ushort value, bool byPassValidation)
        {
            Value = value;
        }

        public Votes(ushort value)
        {
            TypelyValue.ValidateAndThrow<ushort, Votes>(value);
            Value = value;
        }

        public static ValidationError? Validate(ushort value)
        {
            if (value == default)
            {
        ...
        public static Votes From(ushort value) => new(value);

        public static bool TryFrom(ushort value, out Votes typelyType, out ValidationError? validationError)
        {
        ...
        {
            if(ushort.TryParse(value, out var underlyingValue))
            {
        ...
        public static explicit operator ushort(Votes value) => value.Value;
    }
}