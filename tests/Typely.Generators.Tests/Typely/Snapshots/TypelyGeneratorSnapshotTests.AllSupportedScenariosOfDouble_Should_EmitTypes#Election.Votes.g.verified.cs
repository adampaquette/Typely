...
namespace Election
{
    [TypeConverter(typeof(TypelyTypeConverter<double, Votes>))]
    [JsonConverter(typeof(TypelyJsonConverter<double, Votes>))]
    public readonly partial struct Votes : ITypelyValue<double, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        public double Value { get; }

        private Votes(double value, bool byPassValidation)
        {
            Value = value;
        }

        public Votes(double value)
        {
            TypelyValue.ValidateAndThrow<double, Votes>(value);
            Value = value;
        }

        public static ValidationError? Validate(double value)
        {
            if (value == default)
            {
        ...
        public static Votes From(double value) => new(value);

        public static bool TryFrom(double value, out Votes typelyType, out ValidationError? validationError)
        {
        ...
        {
            if(double.TryParse(value, out var underlyingValue))
            {
        ...
        public static explicit operator double(Votes value) => value.Value;
    }
}