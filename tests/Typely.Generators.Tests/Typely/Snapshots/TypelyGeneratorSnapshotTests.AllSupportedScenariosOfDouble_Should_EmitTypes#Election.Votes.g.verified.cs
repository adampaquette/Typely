...
namespace Election
{
    ...
    public partial struct Votes : ITypelyValue<double, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        ...
        public static bool TryFrom(double value, [MaybeNullWhen(false)] out Votes typelyType, out ValidationError? validationError)
        {
