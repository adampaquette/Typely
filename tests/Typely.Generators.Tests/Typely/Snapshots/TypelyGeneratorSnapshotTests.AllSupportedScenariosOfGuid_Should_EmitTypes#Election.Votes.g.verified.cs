...
namespace Election
{
    ...
    public readonly partial struct Votes : ITypelyValue<Guid, Votes>, IEquatable<Votes>, IComparable<Votes>, IComparable
    {
        public Guid Value { get; }

        private Votes(Guid value, bool byPassValidation)
        {
            Value = value;
        }
